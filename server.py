...
def _build_image_url(image_path: Path) -> str:
    ...
    # e.g. runs/session_123/round_1/images/candidate_1.png → /files/session_123/round_1/images/candidate_1.png
...
def run_pipeline():
    """Run the full 2-pass pipeline and return PipelineResult JSON."""
    ...
    try:
        ...
        for round_num in range(1, num_rounds + 1):
            ...
            # --- Pass 2 / Refine ---
            if round_num == 1:
                print(f"  [pass 2] Selecting styles & generating prompts …")
                ...
                print(f"  [refine] Improving prompts …")
            ...
            # --- Generate images ---
            print(f"  [image] Generating 3 images …")
            ...
            round_data = {
                ...
                "images": [
                    {"candidate": i + 1, "url": _build_image_url(ip)}
            ...
            rounds_resp.append(round_data)
            prev_prompts = designer_prompts

        result = {
            "session_id": session_id,
            "user_prompt": user_prompt,
            "testers": testers_resp,
            "rounds": rounds_resp,
        }
